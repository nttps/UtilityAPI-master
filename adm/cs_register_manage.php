...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: cs_register.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_register.php"><?= $_SESSION[register] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                            ...
                            <form id="form-action">
                                    ...
                                    <div class="col-md-12" style="display: none">
                                        <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input has-success" >
                                                        <select class="form-control edited bold" onchange="ChangeStatus()" id="status" name="status" style="color:black;font-weight:bold;">
                                                            <option value="-1"></option>
                                                        </select>
                                                    ...
                                                    <div class="form-group form-md-line-input has-success" style="margin-bottom: 0px !important;">
                                                        ...
                                                        <label for="form_control_1"><?= $_SESSION[lb_status_mail] ?></label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-green">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_user] ?></span>
                                                </div>
                                            </div>
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <!--                                                    <div class="form-group form-md-line-input has-success">
                                                                                                            <input type="text" class="form-control bold" id="s_password"  name="s_password">
                                                                                                            <label for="form_control_1"><?= $_SESSION[lb_cs_password] ?> <span class="required" id="req_pass">*</span></label>          
                                                                                                        </div>-->
                                                    <div class="form-group form-md-line-input has-success" style="margin-bottom: 0px !important;">
                                                ...
                                                <div class="form-actions noborder">
                                                    <a href="javascript:void(0)" class="btn blue" onclick="sendMail()"><?= $_SESSION[btn_send_confirm] ?></a>
                                                </div>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-green">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_user_deposit] ?></span>
                                                </div>
                                            </div>
                                            <div class="portlet-body form">

                                                <div class="form-body">
                                                    <input type="hidden" id="s_ref_deposit" name="s_ref_deposit" />
                                                    <div class="form-group form-md-line-input has-success ">
                                                    ...
                                                    <div class="form-group form-md-line-input has-success">
                                                        <input ng-model="amount"   ng-change="changeValue()" ng-init="amount = '0'"  type="text" class="form-control bold" id="f_amount" name="f_amount">
                                                    ...
                                                    <div class="form-group form-md-line-input has-success">
                                                        <select class="form-control edited bold" id="i_bank_pay" name="i_bank_pay">
                                                            <!--<option value="-1"></option>-->
                                                        </select>
                                                        <label for="form_control_1"><?= $_SESSION[lb_cs_bank] ?></label>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="cs_register.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
