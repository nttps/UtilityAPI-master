                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_register] ?></span>
                                        </div>
                                        <div class="actions">
...
<!--                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" align="left"  <?=$hidden?>>
                                                    <div class="btn-group">
                                                       <div class="btn-group">
                                                           <a href="cs_register_manage.php?func=add">
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_register.js" type="text/javascript"></script>
