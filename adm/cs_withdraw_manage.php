...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: cs_withdraw.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_withdraw.php"><?= $_SESSION[withdraw] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body"> 
                                                ...
                                                <div class="form-group form-md-line-input has-success">
                                                    <select class="form-control edited bold" id="i_bank_adm" name="i_bank_adm">
                                                        <!--<option value="-1"></option>-->
                                                    </select>
                                                    <label for="form_control_1"><?= $_SESSION[lb_cs_bank_adm] ?></label>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="f_amount" name="f_amount">
                                                    <label for="form_control_1"><?= $_SESSION[lb_cs_wd_amount] ?> <span class="required">*</span></label>          
                                                </div>
                                                ...
                                                <?php if ($_GET[func] == "edit") { ?>
                                                    <!--                                                    <div class="form-group form-md-line-input has-success">
                                                                                                            ...
                                                                                                            <label for="form_control_1"><?= $_SESSION[lb_cs_bank] ?>
                                                                                                                <span id="class_val_bank" class="" >
                                                                                                                    <i id="icon_val_bank" class=""></i>
                                                                                                                    <span id="lb_val_bank"></span>
                                                                                                                </span>
                                                                                                            </label>
                                                                                                        </div>-->
                                                <?php } else { ?> 
                                                    <!--                                                    <div class="form-group form-md-line-input has-success">
                                                                                                            <select class="form-control edited bold" id="i_bank_add" name="i_bank_add" style="color:black;font-weight:bold;">
                                                                                                                <option value="-1"></option>
                                                                                                            </select>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption font-green">
                                                    ...
                                                    <a href="javascript:findBank();" class="btn btn-circle  blue">
                                                        <i class="fa fa-bank "></i>
                                                        <span class="caption-subject bold uppercase"> <?= $_SESSION[find_bank_auto] ?></span>
                                                    </a>
                                            ...
                                            <div class="portlet-body form">
                                                <label for="form_control_1" style="color: red;" id="error_bank"></label>
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input has-success">
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_withdraw_manage.js" type="text/javascript"></script>
