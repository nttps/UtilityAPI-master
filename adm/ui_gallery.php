                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_mg_gallery] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="right" <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="ui_gallery_manage.php?func=add">
...
<![endif]-->
        ...
        <script src="js/action/ui_gallery.js" type="text/javascript"></script>
