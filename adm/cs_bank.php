                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_bank] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="cs_bank_manage.php?func=add">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>  <?= $_SESSION[tb_co_bank_no] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_bank_name_th] ?> </th>
                                                    <!--<th>  <?= $_SESSION[tb_co_bank_name_en] ?> </th>-->
                                                    <th>  <?= $_SESSION[lb_bank_amt_base] ?> </th>
                                                    <th>  <?= $_SESSION[lb_bank_amt_current] ?> </th>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_bank.js" type="text/javascript"></script>
