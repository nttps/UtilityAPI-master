                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <?php if ($_GET[func] == "edit") { ?>
                                                    <div class="form-group form-md-line-input has-success ">
                                                        <input type="text" class="form-control bold" id="s_datetime" name="s_datetime" disabled="disabled">
                                                        <label for="form_control_1"><?= $_SESSION[lb_cs_datetime] ?> <span class="required">*</span></label>          
                                                    </div>
                                                <?php } ?>
                                                ...
                                                <div class="form-group form-md-line-input has-success " style="margin-bottom: 0px !important;">
                                                    <select class="form-control edited bold" id="i_promotion"  name="i_promotion" >
                                                        <option value=""></option>
                                                    </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="demo_dp.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
