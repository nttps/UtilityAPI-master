...
function getDDLPointion() {
    $.ajax({
        type: 'GET',
        url: 'controller/commonPOController.php?func=DDLPointion',
        beforeSend: function ()
        {
            //$('#se-pre-con').fadeIn(100);
        },
...
function edit() {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/poPictureController.php?func=getInfo&id=' + keyEdit,
        beforeSend: function ()
        {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                if (item.s_img_p1 != "") {
                    $('#img1').attr('src', 'upload/postpicture/' + item.s_img_p1);
