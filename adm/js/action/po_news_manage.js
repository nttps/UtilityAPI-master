...
function getDDLPointion() {
    $.ajax({
        type: 'GET',
        url: 'controller/commonPOController.php?func=DDLPointionNEWS',
        beforeSend: function ()
        {
            //$('#se-pre-con').fadeIn(100);
        },
...
function edit() {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/poNewsController.php?func=getInfo&id=' + keyEdit,
        beforeSend: function ()
        {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                if (item.s_img_p1 != "") {
                    $('#img1').attr('src', 'upload/postnews/' + item.s_img_p1);
                    $("#tmp_img_p1").val(item.s_img_p1);
                }
                if (item.s_img_p2 != "") {
                    $('#img2').attr('src', 'upload/postnews/' + item.s_img_p2);
