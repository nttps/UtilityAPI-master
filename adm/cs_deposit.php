                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_mg_dp] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="cs_deposit_manage.php?func=add">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> <?= $_SESSION[lb_game] ?> </th>
                                                    <th> <?= $_SESSION[tb_co_username] ?> </th>
                                                    <!--<th> <?= $_SESSION[tb_co_name] ?> </th>-->
                                                    <th>  <?= $_SESSION[tb_co_bank] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_amount] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_datetime] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_premise] ?> </th>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_deposit.js" type="text/javascript"></script>
