                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="ui_gallery.php"><?= $_SESSION[gallery] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                        ...
                                        <div class="portlet light bordered" >
                                            <div class="portlet-title">
                                                <div class="caption font-green">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> <?= $_SESSION[lb_uim_img_1] ?> 200*200</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12" id="div-img2" style="display:none">
                                        <div class="portlet light bordered" >
                                            <div class="portlet-title">
                                                <div class="caption font-green">
                                                    <i class="fa fa-image font-green"></i>
                                                    <span class="caption-subject bold uppercase"> <?= $_SESSION[lb_uim_img_2] ?> 1920*1080</span>
                                                </div>
                                            </div>
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"  style="max-width: 200px; max-height: 150px;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="ui_gallery.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/ui_gallery_manage.js" type="text/javascript"></script>
