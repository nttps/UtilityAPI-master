...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: cs_bank.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_bank.php"><?= $_SESSION[bank] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="s_bank_no" name="s_bank_no">
                                                    <label for="form_control_1"><?= $_SESSION[lb_cs_bankno] ?> <span class="required">*</span></label>          
                                                </div>
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="s_bank_name_th"  name="s_bank_name_th">
                                                    <label  for="form_control_1"><?= $_SESSION[lb_cs_bank_name_th] ?> <span class="required">*</span>
                                                    </label>          
                                                </div>
                                                <!--<div class="form-group form-md-line-input has-success" >
                                                                                                    <input type="text" class="form-control bold" id="s_bank_name_en" name="s_bank_name_en">
                                                                                                    <label for="form_control_1"><?= $_SESSION[lb_cs_bank_name_en] ?> <span class="required">*</span>
                                                                                                    </label>          
                                                                                                </div>-->
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="number" class="form-control bold" id="f_amount_base"  name="f_amount_base" value="0" min="0">
                                                    <label  for="form_control_1"><?= $_SESSION[lb_bank_amt_base] ?> <span class="required">*</span>
                                                    </label>          
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="cs_bank.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_bank_manage.js" type="text/javascript"></script>
