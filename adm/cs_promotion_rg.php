                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_promotion_rg.php"><?= $_SESSION[promotion_rg] ?></a>
                                </li>
                            </ul>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_promotion_rg] ?></span>
                                        </div>
                                        <div class="actions">
...
<!--                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" align="left"  <?=$hidden?>>
                                                    <div class="btn-group">
                                                        <a href="cs_promotion_rg_manage.php?func=add">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>  <?= $_SESSION[tb_co_prom_name_th] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_prom_name_en] ?> </th>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_promotion_rg.js" type="text/javascript"></script>
