...
$controller = new promotionCSController();
switch ($info[func]) {
    case "dataTable":
...
class promotionCSController {

    public function dataTable() {
        include '../service/promotionCSService.php';
        $service = new promotionCSService();
...
//            echo $return2099;
            ...
            echo $return2003;
        }else if (!is_numeric($info[i_use])) {
            $return2003 = eregi_replace("field", $_SESSION['lb_cs_use'], $return2003);
            echo $return2003;
