...
$controller = new poNewsController();
switch ($info[func]) {
    case "dataTable":
...
class poNewsController {

    public function dataTable() {
        include '../service/poNewsService.php';
        $service = new poNewsService();
    ...
    public function delete($seq) {
        ...
        if ($service->delete($db, $seq)) {
            ...
            $upload->set_path("../upload/postnews/");
    ...
    public function deleteTempFile($db) {
        $temp = new upload();
        $svTemp = new poNewsService();
        $temp->set_path("../upload/postnews/");
