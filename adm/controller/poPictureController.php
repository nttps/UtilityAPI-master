...
$controller = new poPictureController();
switch ($info[func]) {
    case "dataTable":
...
class poPictureController {

    public function dataTable() {
        include '../service/poPictureService.php';
        $service = new poPictureService();
    ...
    public function delete($seq) {
        ...
        if ($service->delete($db, $seq)) {
            ...
            $upload->set_path("../upload/postpicture/");
    ...
    public function edit($info) {
        if ($this->isValid($info)) {
            ...
            $service = new poPictureService();
            $doc = new upload();
            $doc->set_path("../upload/postpicture/");
    ...
    public function deleteTempFile($db) {
        $temp = new upload();
        $svTemp = new poPictureService();
        $temp->set_path("../upload/postpicture/");
