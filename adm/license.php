                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_license] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <div class="btn-group">
                                                            <a href="license_manage.php?func=add">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> <?= $_SESSION[tb_co_domain] ?> </th>
                                                    <th> <?= $_SESSION[tb_co_license] ?> </th>
                                                    <th>  <?= $_SESSION[tb_co_function] ?> </th>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/license.js" type="text/javascript"></script>
